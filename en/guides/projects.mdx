...
<Steps>
  ...
  <Step title="Fill in the information">
    ...
    - **Icon**: Choose an icon to quickly identify the project
  </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="Tools & Integrations" icon="plug">
    Connections to configured APIs and MCP tools
  </Card>
...
<Tip>
  Use folders to group related agents. For example: "Lead Generation" can contain multiple agents working together.
</Tip>
...
- **MCP Integrations**: Connect Slack, Gmail, CRM once
- **Custom APIs**: Define your endpoints at project level
