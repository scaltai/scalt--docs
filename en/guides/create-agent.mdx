...
<Steps>
  ...
  <Step title="Launch the Assistant">
    Click **"Create an agent"** then select **"Scalt Assistant"**
  </Step>
...
<Tip>
  The Playground uses an isolated environment. Actions are not actually executed (emails not sent, data not modified).
</Tip>
...
<AccordionGroup>
  ...
  <Accordion icon="user-plus" title="Customer onboarding">
    "Create an agent that automates onboarding: creates accounts, sends access credentials, schedules a demo and adds to CRM"
  </Accordion>
