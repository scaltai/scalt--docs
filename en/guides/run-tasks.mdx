...
In tasks pages, invoke your agents using "@" symbol to select the agent you want to execute.
...
<Info>
  **@analyst** read this document and give a short summary **@planner** use the summary to plan the next steps   
<Info>
