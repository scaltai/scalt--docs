...
<Steps>
  ...
  <Step title="Remplissez les informations">
    ...
    - **Icône** : Choisissez une icône pour identifier rapidement le projet
  </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="Outils & Intégrations" icon="plug">
    Les connexions aux APIs et outils MCP configurés
  </Card>
...
<Tip>
  Utilisez des dossiers pour regrouper les agents liés. Par exemple : "Génération de leads" peut contenir plusieurs agents travaillant ensemble.
</Tip>
...
- **Intégrations MCP** : Connectez Slack, Gmail, CRM une seule fois
- **APIs personnalisées** : Définissez vos endpoints au niveau projet
